...
public class SnapshooterEditPart extends AbstractGraphicalEditPart {
	...
	protected void refreshVisuals() {
		...
		Label label = new Label(((Snapshooter)getModel()).getName());
		...
		getFigure().add(label);
		getFigure().setBackgroundColor(new Color(null, 10, 255, 255));
	}
