...
public class ModelElementTypes {
	...
	* @generated
	*/
	public static final IElementType Car_1000 = getElementType("Model.diagram.Car_1000"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Color_4001 = getElementType("Model.diagram.Color_4001"); //$NON-NLS-1$
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Car_1000, ModelPackage.eINSTANCE.getCar());

			elements.put(Color_4001, ModelPackage.eINSTANCE.getColor());
		}
	...
	*/
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Car_1000);
			KNOWN_ELEMENT_TYPES.add(Color_4001);
		}
