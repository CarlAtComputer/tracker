...
public class ModelDiagramEditorUtil {
	...
	*/
	public static boolean openDiagram(Resource diagram) throws PartInitException {
		...
		page.openEditor(new URIEditorInput(diagram.getURI()), ModelDiagramEditor.ID);
		return true;
	}
	...
	*/
	...
	public static Resource openModel(Shell shell, String description, TransactionalEditingDomain editingDomain) {
		...
		try {
			...
			ModelDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + uri, we); //$NON-NLS-1$
			MessageDialog.openError(shell, Messages.ModelDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
					NLS.bind(Messages.ModelDiagramEditorUtil_OpenModelResourceErrorDialogMessage, fileName));
		}
		return resource;
	}
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI, IProgressMonitor progressMonitor) {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(editingDomain,
			...
			protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
				...
				Car model = createInitialModel();
				attachModelToResource(model, modelResource);

				Diagram diagram = ViewService.createDiagram(model, CarEditPart.MODEL_ID,
				...
				try {
					modelResource.save(model.diagram.part.ModelDiagramEditorUtil.getSaveOptions());
					diagramResource.save(model.diagram.part.ModelDiagramEditorUtil.getSaveOptions());
				} catch (IOException e) {
	...
	* @generated
	*/
	private static Car createInitialModel() {
		return ModelFactory.eINSTANCE.createCar();
	}
	...
	* @generated
	*/
	private static void attachModelToResource(Car model, Resource resource) {
