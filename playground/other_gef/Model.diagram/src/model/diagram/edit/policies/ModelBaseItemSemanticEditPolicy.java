 ...
 * @generated
 */
public class ModelBaseItemSemanticEditPolicy extends org.eclipse.gmf.runtime.diagram.ui.editpolicies.SemanticEditPolicy {
 ...
 * @generated
 */
	protected ModelBaseItemSemanticEditPolicy(org.eclipse.gmf.runtime.emf.type.core.IElementType elementType) {
	...
	public org.eclipse.gef.commands.Command getCommand(org.eclipse.gef.Request request) {
		if (request instanceof org.eclipse.gef.requests.ReconnectRequest) {
			...
			if (view instanceof org.eclipse.gmf.runtime.notation.View) {
				Integer id = new Integer(model.diagram.part.ModelVisualIDRegistry.getVisualID((org.eclipse.gmf.runtime.notation.View) view));
 ...
 */
	private org.eclipse.gmf.runtime.emf.type.core.IElementType getContextElementType(org.eclipse.gmf.runtime.emf.type.core.requests.IEditCommandRequest request) {
		org.eclipse.gmf.runtime.emf.type.core.IElementType requestContextElementType = model.diagram.providers.ModelElementTypes.getElementType(getVisualID(request));
 ...
 */
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = model.diagram.part.ModelDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			model.diagram.part.ModelDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
 ...
 * @generated
 */
public boolean canCreateColor_4001(model.Car source,  target) {
				if (source != null) {
			if (source.getColor() != null) {
	return false;
}
			}
				return canExistColor_4001(null, source, target);
}
 ...
 * @generated
 */
	public boolean canExistColor_4001(model.Color linkInstance, model.Car source,  target) {
		return true;
	}
}
