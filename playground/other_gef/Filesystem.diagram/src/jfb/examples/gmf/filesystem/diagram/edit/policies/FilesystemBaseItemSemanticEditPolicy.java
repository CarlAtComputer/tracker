...
public class FilesystemBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(FilesystemVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = FilesystemElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = FilesystemDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			FilesystemDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateFolderFolders_4001(Folder source, Folder target) {
			if (source != null) {
			...
			return canExistFolderFolders_4001(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreateFolderFiles_4002(Folder source, File target) {
			if (source != null) {
			...
			return canExistFolderFiles_4002(source, target);
		}

		/**
		* @generated
		*/
		public boolean canExistFolderFolders_4001(Folder source, Folder target) {
			return true;
		}
		...
		* @generated
		*/
		public boolean canExistFolderFiles_4002(Folder source, File target) {
			return true;
		}
	}
