...
public class FolderNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new FilesystemTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FilesystemParserProvider.getParser(FilesystemElementTypes.Folder_2001, getParserElement(),
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, FilesystemEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
