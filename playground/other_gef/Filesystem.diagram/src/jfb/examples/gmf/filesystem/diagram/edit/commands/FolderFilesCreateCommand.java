...
public class FolderFilesCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public FolderFilesCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return FilesystemBaseItemSemanticEditPolicy.getLinkConstraints().canCreateFolderFiles_4002(getSource(),
				getTarget());
	}
