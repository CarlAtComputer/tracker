...
public class FolderFoldersReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return FilesystemBaseItemSemanticEditPolicy.getLinkConstraints().canExistFolderFolders_4001(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return FilesystemBaseItemSemanticEditPolicy.getLinkConstraints().canExistFolderFolders_4001(getOldSource(),
				getNewTarget());
	}
