 ...
 * @generated
 */
public class ClerkItemSemanticEditPolicy extends TrackerBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ClerkItemSemanticEditPolicy() {
		super(TrackerElementTypes.Clerk_2003);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (TrackerVisualIDRegistry.getVisualID(incomingLink) == ChronosClerkEditPart.VISUAL_ID) {
