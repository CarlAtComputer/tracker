...
public class TrackerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TrackerPackage.CHRONOS: {
				Chronos chronos = (Chronos)theEObject;
				T result = caseChronos(chronos);
			...
			case TrackerPackage.SNAPSHOOTER: {
				Snapshooter snapshooter = (Snapshooter)theEObject;
				T result = caseSnapshooter(snapshooter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TrackerPackage.CLERK: {
				Clerk clerk = (Clerk)theEObject;
				T result = caseClerk(clerk);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TrackerPackage.DATASOURCE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Snapshooter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Snapshooter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSnapshooter(Snapshooter object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Chronos</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Chronos</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChronos(Chronos object) {
		return null;
	}
